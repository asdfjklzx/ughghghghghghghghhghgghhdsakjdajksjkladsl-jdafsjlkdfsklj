      ...
      return n.React.createElement(
        ...
        _canSwipe
          ? n.React.createElement(
              ...
              n.React.createElement(
                _SV,
                { ref: _scrollRef, horizontal: true, pagingEnabled: true, bounces: false, disableIntervalMomentum: true, decelerationRate: "fast", showsHorizontalScrollIndicator: false, keyboardShouldPersistTaps: "handled", onMomentumScrollEnd: function (ev) { try { setTab(Math.round(ev.nativeEvent.contentOffset.x / _width)); } catch {} } },
                n.React.createElement(
                  _View,
                  { style: { width: _width, overflow: "hidden" } },
                  n.React.createElement(
                    _SV,
                    { style: { width: _width, maxHeight: 560 }, contentContainerStyle: { paddingTop: 8, paddingHorizontal: 14, paddingBottom: 180 }, keyboardShouldPersistTaps: "handled", nestedScrollEnabled: true, showsVerticalScrollIndicator: true },
        n.React.createElement(
          N,
          { title: "Fake Message" },
